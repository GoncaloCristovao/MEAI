 ...
 * - Always use MUX A
 * - Negative input to ADC is AVss (Vref-)
...
/**
 * \brief Selects ADC source channel. 
 * 
 * Requires previous full configuration of ADC with ADCconfig()
 * @param sourceChannel Source channel (0 to 15)
 */
